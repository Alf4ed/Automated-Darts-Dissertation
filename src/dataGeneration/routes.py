...
def displayRoutes():
    ...
    for i in range(2, 180):
        ...
        if i not in normal.IMPOSSIBLE_CHECKOUTS[2]:
            ...
            aim = display.score_dart(max_index[0]-200, max_index[1]-200)
            out1 = aim.to_string()
            ...
            if i-aim.value() == 0:
                ...
                aim2 = display.score_dart(max_index2[0]-200, max_index2[1]-200)
                out2 = aim2.to_string()
                ...
                if i-aim.value()-aim2.value() == 0:
                    ...
                    aim3 = display.score_dart(max_index3[0]-200, max_index3[1]-200)
                    out3 = aim3.to_string()
                else:
                    out3 = "IMPOSSIBLE"
            else:
